...
namespace NewsArticle.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Registro(RegistroViewModel modelo)
        {
            ...
            var usuario = new Usuario() {Nombre = modelo.Nombre, Email = modelo.Email };
            ...
            if (resultado.Succeeded)
            {
                ...
                return RedirectToAction("Index", "NoticiaPeriodistica");
            }
            else
            {
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            catch (Exception ex)
            {
                ...
                ModelState.AddModelError(string.Empty, "Ha ocurrido un error al cerrar sesión");
                return RedirectToAction("Index", "NoticiaPeriodistica");
            }
        }
    }
