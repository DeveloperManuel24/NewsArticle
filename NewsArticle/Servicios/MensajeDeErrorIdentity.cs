...
namespace NewsArticle.Servicios
{
    public class MensajeDeErrorIdentity : IdentityErrorDescriber
    {
        ...
        public override IdentityError PasswordTooShort(int length) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"La contraseña debe tener un largo mínimo de {length} caracteres." }; }
