...
public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
{
    ...
    }//Funcion que verifica el password y ademas lo verifica de una del modelo usuario porque eso se obtuvo de BuscarUsuarioPorEmail
